...
namespace OOP_laba4
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            //объект TreeView должен «подписаться» на объект Storage и, получая уведомления, перестраивать свое содержимое 
        ...
        private void PaintPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            for(FigureStorage.First(FigureStorage.GetFirst()); !FigureStorage.EOL; FigureStorage.Next())
            {
        ...
        protected void CreateFigureOperation(int x, int y)
        {
            ...
            {
                DoCommand(new CreateFigureCommand(FigureStorage, code, x, y, (int)WidthNum.Value, (int)HeightNum.Value));
        ...
        {
            FigureStorage.First(            FigureStorage.GetFirst());
        ...
        private void CheckBeyonds_CheckedChanged(object sender, EventArgs e)
        {
