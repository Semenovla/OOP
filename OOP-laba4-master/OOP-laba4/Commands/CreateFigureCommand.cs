...
namespace OOP_laba4.Commands
{
    public class CreateFigureCommand : ICommand
    {
        ...
        public CreateFigureCommand(Storage<Figure> figures, string code, int x, int y, int width, int height)
        {
        ...
        {
            var com = new CreateFigureCommand(figures, code, x, y, width, height);
